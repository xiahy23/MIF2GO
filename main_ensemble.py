...
from trainNN_ensemble import train_nn  # 使用集成版本
import numpy as np
import pandas as pd
import os
import torch
...
def train(args):
    ...
    print("Start running supervised model with ensemble learning...")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--thr_combined', type=float, default=0.4, help="threshold for combiend ppi network.")
    ...
    parser.add_argument('--save_model', type=bool, default=True, help="save the trained model or not.")
